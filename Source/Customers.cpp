...
public:
	...
	CustomersRowComponent(CoeusList &owner_, bool addComp_) : CoeusListRowComponent(owner_, addComp_) {
        detailedView = false;
        showControls = false;
        ...
        addAndMakeVisible(CustomerVAT = new CoeusListLabel("VAT", "VAT"));
        ...
        addAndMakeVisible(ShippingAdress = new CoeusListLabel("Shipping Adress", "Shipping Adress"));
        ...
        addAndMakeVisible(CustomerTransactions = new CoeusListLabel("CustomerTransactions", "CustomerTransactions"));
...
CoeusListRowComponent * CustomersTableListBoxModel::refreshComponentForRow(int rowNumber, bool isRowSelected, CoeusListRowComponent *existingComponentToUpdate)
{
    ...
    if (existingComponentToUpdate == nullptr) {
        CustomersRowComponent *newComp = new CustomersRowComponent(*this, false);
...
{
    return new CustomersRowComponent(*customersTableListBoxModel, true);
}
